...
/// <summary>
/// Summary description for AttendanceDataAcessLayer
/// </summary>
public class AttendanceDataAcessLayer
{
    private string connection;
    public AttendanceDataAcessLayer()
    {
        connection = null;
        //this.connection = "Data Source=xclusive21;Initial Catalog=cooperative;Integrated Security=True;";
        this.connection = ConfigurationManager.ConnectionStrings["SkyLineConnectionAttendance"].ToString();
    }
