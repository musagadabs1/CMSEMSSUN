...
public partial class Pages_WeeklyIndividual : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        StudentRegistrationDAL s = new StudentRegistrationDAL();
        Response.Redirect("PrintOtherReport.aspx?A=" + EmpID + "&B=" + FromDate + "&C=" + ToDate + "&D=" + ddlCountry.SelectedValue + "&E=3", false);
    }
}