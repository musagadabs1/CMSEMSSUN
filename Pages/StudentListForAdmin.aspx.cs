...
public partial class Pages_StudentListForAdmin : System.Web.UI.Page
{
    ...
    protected void gvStudentList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("Modify"))
            {
                ...
                Response.Redirect(string.Format("AdmissionCheckList.aspx?Id=" + Id + "&Flag=" + chkNonRegister.Checked), false);
            }
