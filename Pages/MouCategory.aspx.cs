...
public partial class Pages_SeatAllocations : System.Web.UI.Page
{
    ...
    protected void GvTOC_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "inactive")
        {
           // StudentRegistrationDAL d = new StudentRegistrationDAL();
            ...
            s.Deletecategory(Convert.ToInt32(HiddenField1.Value));
    ...
    protected void linkbuttonclick(object sender, EventArgs e)
    {
        ...
        GridView gvr = (GridView)lnkbtn.NamingContainer;
        HiddenField hdnDataId = (HiddenField)gvr.FindControl("hid_sno");
        s.Deletecategory(Convert.ToInt32(hdnDataId.Value));
        Bindgrid();
    }
