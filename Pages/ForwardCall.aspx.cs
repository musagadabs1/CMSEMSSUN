...
public partial class Pages_ForwardCall : System.Web.UI.Page
{
    ...
    private void FillGridView(int iPageNo, int iPageRecords)
    {
        ...
        try
        {
            ...
            StudentRegistrationDAL s = new StudentRegistrationDAL();
            dt = s.GetFollowUpDetails1(FilterBy, txtFilterValue.Text, EmpId, FromDate, ToDate, iPageNo, iPageRecords,Drpschool.SelectedValue);
    ...
    protected void gvStudentList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("Modify"))
            {
                ...
                Response.Redirect(string.Format("InsertForwardCall.aspx?Id={0}&sid={1}", Id,Drpschool.SelectedValue), false);
            }
