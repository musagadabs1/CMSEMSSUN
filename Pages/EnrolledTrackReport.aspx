<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ReportMaster.master"  CodeFile="EnrolledTrackReport.aspx.cs" Inherits="Pages_EnrolledTrackReport" %>
    ...
    <div id="all-form-wrap">
        ...
        <div class="form-fieldset-wrapper">
            ...
            <div class="form-fieldset-wrapper-top">
                ...
                <h2>
                    Enrolled Student Tracking Report</h2>
            </div>
                ...
                <div class="form-fieldset-wrapper-mid-inner9">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                  <asp:DropDownList ID="ddlMediasource" runat="server" CssClass="textBox11" Width="142px">
                                </asp:DropDownList>
                            </td>
                         ...
                         <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                  <asp:DropDownList ID="Drpstatus" runat="server" CssClass="textBox11" Width="142px">
                                  <asp:ListItem Text=" Only Enrolled" Value=1>
                                  </asp:ListItem>
                                   <asp:ListItem Text=" Not Enrolled" Value=0>
                                  </asp:ListItem>
                            ...
                            <asp:Checkbox ID="chkonline" runat="server" Text="Only Online Enquires" Checked="false" />
                            </td>
