<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/ReportMaster.master" CodeFile="CDBCoursewiseReport.aspx.cs" Inherits="Pages_CDBCoursewiseReport" %>
    ...
    <div id="all-form-wrap">
        ...
        <div class="form-fieldset-wrapper">
            ...
            <div class="form-fieldset-wrapper-top">
                ...
                <h2>
                    CPD Coursewise Summary Report</h2>
            </div>
            ...
            <div class="form-fieldset-wrapper-mid">
                ...
                Report Option  
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:DropDownList ID="ddloption" runat="server" TabIndex="5" CssClass="textBox11"
                                    Width="142px">
                              <asp:listitem text="Daily" value="D">
                                    ...
                                    <asp:listitem text="Semester" value="M">
                                 </asp:listitem>
                                </asp:DropDownList>
                            </td>
                        </tr>
