...
public partial class Pages_Followupexistingstud : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("followupexisting.aspx", false);
            }
    ...
    public void LoadDropdown()
    {
        ...
        try
        {
            ...
            //    ddlStudentStatus.DataSource = s.SetDropdownListCDB(50);
            //    ddlStudentStatus.DataTextField = "CallerStatus";
            //    ddlStudentStatus.DataValueField = "Id";
            //    ddlStudentStatus.DataBind();
            //}
    ...
    private void FillGridView()
    {
        ...
        {
            StudentRegistrationDAL s = new StudentRegistrationDAL();
            gvStudentList.DataSource = s.GetFollowUpDetailsexisting("0", Request.QueryString["Id"].ToString(), "0");
    ...
    protected void BtnGr_Click(object sender, EventArgs e)
    {
        ...
        Pnlstudent.Visible = true;
          lblgrmess.Text = "";
          chkallreg_Checked(sender, e);

      
    }

    protected void chkallreg_Checked(object sender, EventArgs e)
    {
        drpstud.Items.Clear();
        StudentRegistrationDAL s = new StudentRegistrationDAL();
        ...
        if (chkallreg.Checked==true)
        {
          ...
          drpstud.DataSource = s.SetDropdownListAsDegreeType(49,0);
          drpstud.DataTextField = "stud_id";
          drpstud.DataValueField = "stud_id";
          drpstud.DataBind();
        }
        else
        ...
        {
            drpstud.DataSource = s.SetDropdownListAsDegreeType(48, int.Parse(Request.QueryString["Id"].ToString()));
            drpstud.DataTextField = "stud_id";
          drpstud.DataValueField = "stud_id";
          drpstud.DataBind();
