<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage.master" CodeFile="SearchStudentSC.aspx.cs" Inherits="Pages_SearchStudentSC" %>
        ...
        <div id="all-form-wrap">
            ...
            <div class="form-fieldset-wrapper">
                ...
                <div class="form-fieldset-wrapper-top">
                    ...
                    <h2>
                        Search Student ShortCourses </h2>
                </div>
                                ...
                                <asp:Panel ID="Panel1" runat="server">
                                    <div id="list-member-block" style="width: 693px">
                                        <asp:GridView ID="gvStudentList" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
                                            ...
                                            onpageindexchanging="gvStudentList_PageIndexChanging" PageSize="20" >
