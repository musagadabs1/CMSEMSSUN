<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ReportMaster.master"  CodeFile="COECCPDMail.aspx.cs" Inherits="Pages_COECCPDMail" %>
...
<tr>
<td>
<asp:HyperLink ID="hypcpd" runat="server" Text="CPD Reports"  Target="_blank"></asp:HyperLink></td>
                     ...
                     <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px; width: 90%">
                                <asp:TextBox ID="txtTo" runat="server" Width="625px"  Text="cpd@skylineuniversity.ac.ae" CssClass="fontstyle"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:TextBox ID="txtSubject" runat="server" Width="625px" Text="CPD STATISTICS REPORTS"></asp:TextBox>
