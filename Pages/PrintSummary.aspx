<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PrintSummary.aspx.cs" Inherits="Pages_PrintSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <%-- <div id="non-printable">
    <input name="b_print" type="button" onclick="printdiv('printReady1')" value=" Print " />
    </div>
