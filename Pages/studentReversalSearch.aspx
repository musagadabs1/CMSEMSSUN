<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentReversalSearch.aspx.cs"  MasterPageFile="~/MasterPage.master" Inherits="Pages_studentReversalSearch" %>
                    ...
                    <td>
                        <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                               ...
                               <asp:TemplateField HeaderText="RegistrationNo" ItemStyle-Width="40%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="regno" runat="server" CommandName="Modify" CommandArgument='<%#Eval("Id") %>'
                                            ForeColor="Blue" Font-Underline="true" Width="90%" Text='<%# HighlightText(Eval("registrationno").ToString()) %>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<asp:ControlParameter Name="Name" ControlID="txtSearch" PropertyName="Text" />
    ...
    <asp:SqlDataSource ID="dsDetails" runat="server" ConnectionString="<%$ConnectionStrings:CDBConnectionString2 %>"
        SelectCommand="sp_displayrecordsexisting" UpdateCommand="sp_displayrecordsexisting" UpdateCommandType="StoredProcedure"
        SelectCommandType="StoredProcedure" FilterExpression="calldate1 LIKE '%{0}%' or firstName LIKE '%{0}%'  or LastName LIKE '%{0}%' or  Mobileno LIKE '%{0}%' or CallerStatus LIKE '%{0}%' or Degreecode LIKE '%{0}%' or AttendedBy LIKE '%{0}%'  or Emailid LIKE '%{0}%' or registrationno LIKE '%{0}%' ">
        <FilterParameters>
