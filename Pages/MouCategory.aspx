                    ...
                    <div class="form-fieldset-wrapper-mid-inner">
                        <table class="style1" border="1" >
                            ...
                            <tr>                            
                                ...
                                <td>
                                    ...
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="Numbers"
                                         TargetControlID="txt_std_allocated">
                                    </cc1:FilteredTextBoxExtender>
                                </td>                            
                            ...
                            <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_af" runat="server" Width="87px" ReadOnly="true" ></asp:TextBox>
        ...
        <asp:GridView ID="gvTOC" runat="server" AutoGenerateColumns="false" CssClass="grid-view" OnSorting="gvTOC_OnSorting"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Change Status">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkdelete" runat="server" CommandName="inactive"  OnClientClick="javascript: return confirm('Are you sure you want to Inactive?')"
                            CommandArgument='<%#Eval("SNO")%>' Text="InActive"></asp:LinkButton>
                    </ItemTemplate>
                    <ItemStyle Width="10px" HorizontalAlign="Center" />
                    <HeaderStyle HorizontalAlign="Center" />
                </asp:TemplateField>
