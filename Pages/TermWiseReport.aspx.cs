...
public partial class Pages_TermWiseReport : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("PrintTermWise.aspx?A=" + EmpID + "&B=" + FromDate + "&C=" + ToDate + "&D=" + ddlCountry.SelectedValue, false);
    }
}