<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterForCallManagement.master"  CodeFile="Followupexistingstud.aspx.cs" Inherits="Pages_Followupexistingstud" %>
                ...
                <div class="form-fieldset-wrapper-mid">
                    ...
                    <div class="form-fieldset-wrapper-mid-inner">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                           ...
                           <tr>
                           <td colspan="4">
                          <asp:Label ID="lblregno" runat="server" Text="" Width="500"  ForeColor="Blue"></asp:Label>
                           </td>
                           </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtName" runat="server" TabIndex="5" CssClass="textBox1" Width="500" ReadOnly="true"></asp:TextBox>
                                </td>  
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <asp:Button ID="BtnGr" runat="server" CssClass="" OnClick="BtnGr_Click" Text="Tag Student"                                                 />
     ...
     <div id="Div3">
        <div class="form-fieldset-wrapper">
            ...
            <div class="form-fieldset-wrapper-top">
                <!--Div for the form fieldset wrapper top rounded part-->
                <h2>
                    Tag Graduate to Joined SUC Student</h2>
            </div>
            <div class="form-fieldset-wrapper-mid">
                <!--Div for the form fieldset wrapper middle part for the left and right border-->
                <div class="form-fieldset-wrapper-mid-inner">
             ...
             <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                            <td>
                                            <asp:Label ID="lblstugr" runat="server"  Text="NewStudentID"></asp:Label>

            <cc3:ComboBox runat="server" ID="drpstud" Width="500" MenuWidth="960" Height="250" EmptyText="Select Student ..."
	    
	    >
                                  
                                       
         <HeaderTemplate>
	           <div class="header c1">Stud_Id</div>
                           <div class="header c2">Name</div>
                            <div class="header c5">Program</div>
	        <div class="header c4">Intake</div>
            <div class="header c3">Mobile</div>
             <div class="header c6">Semester</div>
	    </HeaderTemplate>
	    <ItemTemplate>
           <%-- <div title="<%# Eval("Agencyname").ToString() + " from " + Eval("Agentname").ToString() %>">--%>
           <div>
	             <div class="item c1"><%# Eval("Stud_id")%></div>
	            <div class="item c2"><%# Eval("name")%></div>
                <div class="item c5"><%# Eval("Program")%></div>
                 <div class="item c4"><%# Eval("Termname")%></div>
                 <div class="item c3"><%# Eval("MobileNo")%></div>
                <div class="item c6"><%# Eval("Semester_desc")%></div>
            </div>
	    </ItemTemplate>
	    <FooterTemplate>
	        Displaying <%# Container.ItemsCount %> items.
                                            ...
                                            <td>
                                            <asp:CheckBox ID="chkallreg" Text="All" runat="server" AutoPostBack="true" checked="false" OnCheckedChanged="chkallreg_Checked" />
                                            </td>
                                            <td>
                                            <asp:Button ID="Btnsavegr" Text="Save" runat="server"  OnClick="Btnsavegr_Click"/> 
                                            ...
                                            <td>
                                            <asp:Label ID="lblgrmess" Text="" runat="server"></asp:Label>
            ...
            <div class="form-fieldset-wrapper">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 60%">
                                        <asp:DropDownList ID="ddlPrevStudentStatus" runat="server" TabIndex="5" 
                                            CssClass="textBox9" Enabled="false"
                                           >
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                ...
                <div class="form_right">
                    ...
                    <table width="100%">
                        ...
                        <tr align="center">
                           <%-- <td colspan="2"><asp:Button ID="Button2"  runat="server" ValidationGroup="Submit" CssClass="" OnClick="btnSave_Click"
                                            Text="Update" />--%>
