<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/ReportMaster.master"  CodeFile="COECCMSReportMail.aspx.cs" Inherits="Pages_COECCMSReportMail" %>
...
<td>Select Date range for date range report</td></tr>
<tr>
...
<td>Select Date for Daily CMS report</td></tr><tr>
   <td style="padding: 3px 5px;">
                             CMS Date 
                            </td>
 <td style="padding: 3px 5px;">
                                <asp:TextBox ID="Txtcmsdate" runat="server" CssClass="textBox1" ></asp:TextBox>
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Icons/calendar_view_month.png" />
                                <cc1:calendarextender id="Calendarextender1" runat="server" cssclass="MyCalendar" targetcontrolid="Txtcmsdate"
                                    popupbuttonid="ImageButton1">
                                </cc1:calendarextender>
                                <cc1:filteredtextboxextender id="FilteredTextBoxExtender111" runat="server" filtertype="Custom,Numbers"
                                    validchars="/,-" targetcontrolid="Txtcmsdate">
                                </cc1:filteredtextboxextender>
                            </td>
...
<td>
<asp:HyperLink ID="Hyperconsolidaterange" runat="server" Text="COEC Report-Consolidated Date range CMS"  Target="_blank"></asp:HyperLink>
</td>
...
<td>
<asp:HyperLink ID="Hyperconsolidate" runat="server" Text="COEC Report-Consolidated CMS"  Target="_blank"></asp:HyperLink>
</td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                     <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:TextBox ID="txtSubject" runat="server" Width="625px" Text="CMS REPORTS"></asp:TextBox>
