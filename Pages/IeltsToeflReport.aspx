<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true"
    CodeFile="IeltsToeflReport.aspx.cs" Inherits="Pages_IeltsToeflReport" %>
                ...
                <div class="form-fieldset-wrapper-mid-inner9">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:DropDownList ID="ddlExamStatus" runat="server" TabIndex="5" CssClass="textBox11"
                                    Width="142px">
                                </asp:DropDownList>
                            </td>
                            <td style="padding: 3px 5px;">
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:DropDownList ID="ddlTestType" runat="server" TabIndex="5" CssClass="textBox11"
                                    Width="142px">
                                </asp:DropDownList>
                            </td>
                        </tr>
