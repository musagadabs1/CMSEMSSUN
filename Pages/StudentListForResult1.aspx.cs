...
public partial class Pages_StudentListForResult1 : System.Web.UI.Page
{
    ...
    private void FillGridView()
    {
        ...
        try
        {
            ...
            StudentRegistrationDAL s = new StudentRegistrationDAL();
            System.Data.DataTable dt = s.GetStudentDetails2(FilterBy, txtFilterValue.Text, NonRegistered, EmpId,Drpschool.SelectedValue);
            ...
            if (e.CommandName.Equals("Modify"))
            {
                ...
                try
                {
                    if (Request.QueryString["A"].ToString() == "1")
                        Response.Redirect(string.Format("CmsEmsStudentDetails.aspx?LinkId=" + Id), false);
                    else
                        Response.Redirect(string.Format("IeltsToeflReport.aspx?LinkId=" + Id), false);
                }
                catch
                {
                    Response.Redirect(string.Format("IeltsToeflReport.aspx?LinkId=" + Id), false);
