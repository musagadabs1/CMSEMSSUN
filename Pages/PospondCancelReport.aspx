<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PospondCancelReport.aspx.cs" Inherits="Pages_PospondCancelReport" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                         ...
                         <tr>
                                ...
                                <td style="padding: 3px 5px;">
                                    <asp:DropDownList ID="ddlTerm" runat="server" TabIndex="5" Width="142px" CssClass="textBox9" AppendDataBoundItems="true">
                                ...
                                <td style="padding: 3px 5px;">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlStatus"
                                        CssClass="" ErrorMessage="Status Required!" Font-Size="Large" ForeColor="Red" SetFocusOnError="true"
                                        Display="None" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                </td>
                                </tr>
                        <tr>
