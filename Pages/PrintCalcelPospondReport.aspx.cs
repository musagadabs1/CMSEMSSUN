...
public partial class Pages_PrintCalcelPospondReport : System.Web.UI.Page
{
    ...
    {
        string path = "";
        if(Request.QueryString["D"].ToString() == "P")
            path = Server.MapPath("~/Report/CMS_STUDENT_POSTPONED_REPORTP.rpt");
        else
            path = Server.MapPath("~/Report/CMS_STUDENT_POSTPONED_REPORT.rpt");
