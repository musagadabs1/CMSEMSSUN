<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="EnrollmentSetAllocation.aspx.cs" Inherits="Pages_EnrollmentSetAllocation" %>
    ...
    <div id="all-form-wrap">
        ...
        <div class="form-fieldset-wrapper">
            ...
            <div class="form-fieldset-wrapper-top">
                ...
                <h2>
                    ENROLLMENT SEAT ALLOCATION REPORT</h2>
            </div>
                ...
                <div class="form-fieldset-wrapper-mid-inner9">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="padding: 3px 5px;">
                                <asp:DropDownList ID="ddlEmployee" Visible="false" runat="server" TabIndex="5" CssClass="textBox11"
                                    Width="142px">
                                </asp:DropDownList>
                            </td>
                        </tr>
