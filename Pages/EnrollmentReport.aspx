<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="EnrollmentReport.aspx.cs" Inherits="Pages_EnrollmentReport" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <asp:DropDownList ID="ddlDegree" runat="server" TabIndex="5" CssClass="textBox11"
                                    Width="142px">
                                    <asp:ListItem Value="0">BBA and MBA</asp:ListItem>
